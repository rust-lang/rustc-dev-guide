...
For those using `rustc` as a library, the [`rustc_interface::interface::run_compiler()`][int_rc] function is the main
...
[`rustc_interface::interface::run_compiler`][int_rc]). The `rustc_driver::run_compiler` function takes a bunch of
...
[int_rc]: https://doc.rust-lang.org/nightly/nightly-rustc/rustc_interface/interface/fn.run_compiler.html
